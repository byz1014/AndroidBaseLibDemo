...
public class NetworkUtils {
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) BaseApplication.getBaseApplication().getSystemService(WIFI_SERVICE);
        if (manager == null) {
            return false;
        }
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) BaseApplication.getBaseApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
        if (cm == null) {
            return false;
        }
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) BaseApplication.getBaseApplication().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) {
            return "";
        }
