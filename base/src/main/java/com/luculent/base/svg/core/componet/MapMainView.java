package com.luculent.base.svg.core.componet;
...
import com.luculent.base.svg.SVGMapViewListener;
import com.luculent.base.svg.core.helper.CommonMathHelper;
import com.luculent.base.svg.core.helper.map.SVGBuilder;
import com.luculent.base.svg.overlay.SVGMapBaseOverlay;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                Log.e("save_matrix","5555555555555555");
//                Log.e("byz_show_down",(System.currentTimeMillis() - time)+"");
            ...
            case MotionEvent.ACTION_MOVE:
                if (this.mTouchState == TOUCH_STATE_POINTED) {
                    if (isFirstPointedMove) {
                        ...
                        savedMatrix.set(matrix);
                        Log.e("save_matrix","3333333333333333333");
                    ...
                    if (this.isZoomGestureEnabled) {
                        matrix.set(savedMatrix);
                        Log.e("save_matrix","4444444444444444444");
                    ...
                    if (this.isRotationGestureEnabled) {
                        matrix.set(savedMatrix);
                        Log.e("save_matrix","22222222222222");
                    ...
                    if (this.isScrollGestureEnabled) {
                        matrix.set(savedMatrix);
                        Log.e("save_matrix","11111111111111");
